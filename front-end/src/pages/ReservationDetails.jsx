...
export default function reservationDetails() {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-lg p-6">
      <h2 className="text-3xl font-semibold text-gray-800 mb-6 text-center">Reservation Details</h2>
          ...
          <tbody>
            {reservations.map((reservation) => (
              <tr key={reservation.id} className="odd:bg-white even:bg-gray-100">
                ...
                <td className="px-4 py-2 border border-gray-300">{reservation.message ? reservation.message : "N/A"}</td>
